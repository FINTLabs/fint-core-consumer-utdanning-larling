...
public class PersonController extends ConsumerRestController<PersonResource> {

    public PersonController(CacheService<PersonResource> cacheService, PersonLinker fintLinker, FintFilterService odataFilterService) {
